...
--Destroy Old
if pGUI:FindFirstChild("Ovainum Way Point GUI") then
	pGUI:FindFirstChild("Ovainum Way Point GUI"):Destroy()
end

--Check For Old Way Points
if game:GetService("Workspace"):FindFirstChild("Way Points") then
...
--Properties
App.Name = "Ovainum Way Point GUI"
App.Parent = pGUI
App.Enabled = true
...
TopBarLabel.Text = "Ovainum Way Point GUI"
...
Create.MouseButton1Click:Connect(function()
	local WPF = game:GetService("Workspace"):WaitForChild("Way Points")
...
OvainumAPI:BetterNotify("<font color = \"rgb(200, 160, 64)\">Ovainum</font> Way Points", "Press <b>;</b> to toggle", 2)
